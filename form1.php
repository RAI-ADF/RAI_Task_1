...
<html>
  ...
  <body>
	<div class="container">
		<div class="main">
	      <form  ljnskelamin="get" action="FormResult.php" id="form">
			<h2>FORM 1</h2><hr/>		
			...
			<span><input type="radio" name="ljnskelamin" value="Laki-Laki" id="ljnskelamin" checked> Laki-Laki &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
			<input type="radio" name="ljnskelamin" value="Perempuan" id="ljnskelamin" > Perempuan </span>	
